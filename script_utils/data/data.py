...
def get_inference_input_loader(dataset, batch_size, audit_trigger_idx, debug, emulate, consistency_check, sha3_approx_factor, n_target_test_samples, load_model_weights=True):
